...
//query data skripsi berdasarkan id
  $kakun = query("SELECT * FROM kata_kunci WHERE id = $id")[0];
 
  
//cek apakah tombol udah kepencet atau belum
if (isset($_POST["submit"]) ){
  $ubah = ubah($id, $_POST["judul"]);
        ...
        <form action="" method="post">
         ...
         <input type="hidden" name="id"  value="<?php echo $skr["id"]; ?>">
          ...
          <div class="form-group">
            <label for="judul_skripsi">Kata Kunci (KeyTerm)</label>
            <input type="text" class="form-control" name="judul" id="judul" placeholder="Kata kunci"  required value="<?= $kakun["kata"]; ?>">
          </div>

          <button type="submit" name="submit" class="btn btn-primary"> Ubah Data</button>

          <button type="button" class="btn btn-danger"> <a href="../kata_kunci.php" style="text-decoration: none;  color: white;">Batal/Kembali</a></button>
        </form>
