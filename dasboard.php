...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark static-top" style="background-image:url(gambar/sideatas.png);">
      <!-- Gambar -->      
    ...
    <ul class="navbar-nav ml-auto ml-md-0" n>
...
<div class="garis" style="width: 100%;height: 6px; background-color:#20B2AA"></div>
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="sidebar navbar-nav" style="background-image: url(gambar/side.png);">
    ...
    <!--menu tengah -->  
        <div class="row" style="text-align: center; padding-left: 150px; font-family: verdana">
           ...
           <div class="col-md-10">
              <div>
                 <p><H4>Selamat Datang di</H4></p>
                <p><H4>Pengelompokkan Judul Skripsi Menggunakan Algoritma K-Means Clustering</H4></p>
                <p><H6>Studi kasus : Jurusan Teknik Informatika FT-UMJ</H6></p>
              </div>
           </div>
